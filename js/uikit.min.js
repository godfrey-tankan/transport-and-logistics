/*! UIkit 2.21.0 | http://www.getuikit.com | (c) 2023 techprojectshub | MIT License */
!(function (t) {
  if (
  ...
  if (
          ...
          n.$win.on(
            ...
            n.Utils.debounce(
              (function () {
                var t = function () {
                  return (
                    i(".uk-height-viewport").css("height", window.innerHeight),
                    t
                  );
                };
                return t();
    ...
    n.$html
      .on("touchstart MSPointerDown pointerdown", l, function () {
  ...
  (function (t) {
    ...
    t.component("stackMargin", {
      defaults: { cls: "uk-margin-small-top" },
      boot: function () {
        t.ready(function (i) {
          t.$("[data-uk-margin]", i).each(function () {
            var i,
              e = t.$(this);
            e.data("stackMargin") ||
              (i = t.stackMargin(e, t.Utils.options(e.attr("data-uk-margin"))));
          });
        });
      },
      init: function () {
        ...
        s !== !1 &&
          i.each(function () {
            ...
            i.is(":visible") &&
              (n
                ? i.addClass(e.cls)
                : i.position().top >= s && (n = i.addClass(e.cls)));
          });
      }),
                ...
                ? (this.totoggle.toggleClass(this.options.cls),
                  this.totoggle.each(function () {
                    t.Utils.animate(this, e[0]).then(function () {
                      t.$(this).css("animation-duration", ""),
                        t.Utils.checkDisplay(this);
                    });
                  }))
                : this.totoggle.each(function () {
        ...
        this.find(i.options.target)
          ...
          this.on("click", this.options.target, function (e) {
            ...
            n.is('a[href="#"]') && e.preventDefault(),
              i.find(i.options.target).not(n).removeClass("uk-active").blur(),
        ...
        init: function () {
          ...
          this.find(i.options.target)
            ...
            this.on("click", this.options.target, function (e) {
              var n = t.$(this);
              n.is('a[href="#"]') && e.preventDefault(),
                n.toggleClass("uk-active").blur(),
                n.attr("aria-checked", n.hasClass("uk-active")),
                i.trigger("change.uk.button", [n]);
            });
        },
        getSelected: function () {
        ...
        t.$html.on(i + ".dropdown.uikit", "[data-uk-dropdown]", function (e) {
          ...
          if (!n.data("dropdown")) {
            ...
            ("click" == i ||
              ...
              o.element.trigger(i),
              o.element.find(".uk-dropdown").length && e.preventDefault();
          }
        });
      },
      init: function () {
        ...
        (this.dropdown = this.find(".uk-dropdown")),
          ...
          "click" == this.options.mode || t.support.touch
            ? this.on("click.uikit.dropdown", function (i) {
                var e = t.$(i.target);
                e.parents(".uk-dropdown").length ||
                  ((e.is("a[href='#']") ||
                    e.parent().is("a[href='#']") ||
                    (n.dropdown.length && !n.dropdown.is(":visible"))) &&
                    i.preventDefault(),
                  e.blur()),
                  n.element.hasClass("uk-open")
                    ? (e.is("a:not(.js-uk-prevent)") ||
                        e.is(".uk-dropdown-close") ||
                        !n.dropdown.find(i.target).length) &&
                      n.hide()
                    : n.show();
              })
                    ...
                    (i =
                      e && e != n
                        ? setTimeout(function () {
                          ...
                          }, n.options.hoverDelayIdle)
                        : setTimeout(n.show.bind(n), n.options.delay));
              })
        ...
        t.$html.off("click.outer.dropdown"),
          setTimeout(function () {
            t.$html.on("click.outer.dropdown", function (o) {
              ...
              var s = t.$(o.target);
              e != n ||
                (!s.is("a:not(.js-uk-prevent)") &&
                  !s.is(".uk-dropdown-close") &&
                  n.dropdown.find(o.target).length) ||
                (n.hide(), t.$html.off("click.outer.dropdown"));
            });
          }, 10);
      },
      checkDimensions: function () {
        if (this.dropdown.length) {
          ...
          if (
            (this.centered &&
              (e.css(
                "margin-" + t.langdirection,
                -1 * (parseFloat(o) / 2 - e.parent().width() / 2)
              ),
              (n = e.offset()),
              (o + n.left > s || n.left < 0) &&
                (e.css("margin-" + t.langdirection, ""), (n = e.offset()))),
          ...
          o + (n.left - a) > s &&
            (e.addClass("uk-dropdown-flip"), (n = e.offset())),
            n.left - a < 0 &&
              (e.addClass("uk-dropdown-stack"),
              e.hasClass("uk-dropdown-flip") &&
                (this.flipped ||
                  (e.removeClass("uk-dropdown-flip"),
                  (n = e.offset()),
                  e.addClass("uk-dropdown-flip")),
                setTimeout(function () {
                  (e.offset().left - a < 0 ||
                    (!i.flipped && e.outerWidth() + (n.left - a) < s)) &&
                    e.removeClass("uk-dropdown-flip");
                }, 0)),
  ...
  (function (t) {
    ...
    t.component("gridMatchHeight", {
      defaults: { target: !1, row: !0, ignorestacked: !1 },
      boot: function () {
        t.ready(function (i) {
      ...
      init: function () {
        ...
        (this.columns = this.element.children()),
          ...
          this.columns.length &&
            ...
            t.$html.on("changed.uk.dom", function () {
              (e.columns = e.element.children()),
                (e.elements = e.options.target
                  ? e.find(e.options.target)
                  : e.columns),
                e.match();
            }),
            this.on(
    ...
    t.component("modal", {
      ...
      (t.modal.confirm = function (i, e, n) {
        ...
        var o = t.modal.dialog(
          [
            '<div class="uk-margin uk-modal-content">' + String(i) + "</div>",
            '<div class="uk-modal-footer uk-text-right"><button class="uk-button uk-button-primary js-modal-confirm">' +
              n.labels.Ok +
              '</button> <button class="uk-button uk-modal-close">' +
              n.labels.Cancel +
              "</button></div>",
          ].join(""),
          n
      ...
      (t.modal.prompt = function (i, e, n, o) {
        ...
        var s = t.modal.dialog(
            [
              ...
              '<div class="uk-modal-footer uk-text-right"><button class="uk-button uk-button-primary js-modal-ok">' +
                o.labels.Ok +
                '</button> <button class="uk-button uk-modal-close">' +
                o.labels.Cancel +
                "</button></div>",
      ...
      (t.modal.blockUI = function (i, e) {
        ...
        return (
          (n.content = n.element.find(".uk-modal-content:first")), n.show(), n
        );
      }),
  ...
  (function (t) {
    ...
    t.component("switcher", {
      ...
      init: function () {
        var i = this;
        if (
          (this.on("click.uikit.switcher", this.options.toggle, function (t) {
          ...
          (this.connect = t.$(this.options.connect)),
            ...
            this.connect.length &&
              ...
              this.connect
                .on("click", "[data-uk-switcher-item]", function (e) {
                  e.preventDefault();
    ...
    t.component("tab", {
      ...
      init: function () {
        ...
        (this.current = !1),
          ...
          t.dropdown(this.responsivetab, { mode: "click" }),
          i.trigger("change.uk.tab", [
            this.element
